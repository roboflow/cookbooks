...
def main(name, fps, focus, autofocus):
    ...
    with dai.Device(pipeline) as device:
        ...
        output_filename = f"12-20-2023_videos/m1max_updated_{focus_type}_{name}_{timestamp}.mp4"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Record video with custom settings")
